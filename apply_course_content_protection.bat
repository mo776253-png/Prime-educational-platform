@echo off
echo Applying ultra-aggressive inspection protection to all course content pages...

REM Apply protection to all course content pages
for %%i in (course-content-*.html) do (
    echo Processing %%i...
    
    REM Add the ultra-aggressive protection script to each course content page
    powershell -Command "
...
'@
    ...
    # Find the position to insert the script (before </head>)
...
echo Protection applied to all course content pages!
pause
